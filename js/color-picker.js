/**
 * @file
 * Provides UI/UX progressive enhancements on Centarro Claro's theme settings
 * by creating an HTMLColorInput element and synchronizing its input with a
 * text input to provide an accessible and user-friendly interface.
 * Additionally, provides a select element with pre-defined color values for
 * easy color switching.
 */

((Drupal, settings, once) => {
  const colorSchemeOptions = settings.centarroClaro.colorSchemes;
  ...
  /**
   * Initializes Centarro Claro theme-settings color picker.
  ...
  /**
   * Centarro Claro Color Picker behavior.
   *
